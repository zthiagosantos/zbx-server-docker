...
## OBJETIVO DO PROJETO
Este projeto visa configurar um laboratório Zabbix + Grafana de modo ágil e prático. Este ambiente permite testar e demonstrar as capacidades do Zabbix sem a complexidade de uma instalação em produção.
